...
String consultaSQL= "select isbn,titulo,categoria from Libros"; //3 y 4
rs=sentencia.executeQuery(consultaSQL); //5
while(rs.next()) { %>
...
%>
<a href="FormularioInsertarLibro.jsp">Insertar Libro</a> </body></html>